...
class LoginPage(BasePage):
    ...
    def should_be_register_form(self):
        assert self.is_element_present(*LoginPageLocators.REGISTRATION_FORM), "Registratiom form is not presented"


    def register_new_user(self, email, password):
        email_fild = self.browser.find_element(*LoginPageLocators.EMAIL)
        email_fild.send_keys(email)
        password_fild = self.browser.find_element(*LoginPageLocators.PASSWORD)
